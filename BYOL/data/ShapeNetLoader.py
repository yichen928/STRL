...
class PartNormalDataset(Dataset):
    def __init__(self, npoints, transforms=None, split="trainval", class_choice=None, normal_channel=False):
...
class PartNormalDatasetContrast(Dataset):
    def __init__(self, npoints, transforms=None, split="trainval", class_choice=None, normal_channel=False):
        self.transforms = transforms
        self.npoints = npoints
        self.root = os.path.join(BASE_DIR, 'shapenetcore_partanno_segmentation_benchmark_v0_normal')
...
class WholeNormalDatasetContrast(Dataset):
    def __init__(self, npoints, transforms=None):
        self.transforms = transforms
        self.npoints = npoints
        self.root = BASE_DIR
